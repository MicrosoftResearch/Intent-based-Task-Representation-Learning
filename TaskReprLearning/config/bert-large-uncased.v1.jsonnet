...
// Intent extractor (sum multi-head (16) attention w/ tanh activation)
  ...
  "dataset_reader": [
    {
      ...
      "use_sep_as_eos": true,
      "lowercase": true,
      "framenet_label_path": "data/v1/fe_embs.bert-large-uncased.1024d.txt"
    },
    {
      "type": "task-specification",
      "split": "validation",
  ...
  "model": {
    ...
    "auxiliary": [
      ...
      },
      {
        ...
        "label_embedding_path": "data/v1/fe_embs.bert-large-uncased.1024d.txt",
